...
function ShowCompare(ids_checkboxes) {
    document.getElementById("popup").style.display = "block";
    UpdateCompareTable(ids_checkboxes);
}

function UpdateCompareTable(ids_checkboxes) {
    let { veiculo1, veiculo2 } = SetCarToCompare(ids_checkboxes);
    ...
    document.getElementById("vehicle2-preco").textContent = veiculo2.preco;
}
