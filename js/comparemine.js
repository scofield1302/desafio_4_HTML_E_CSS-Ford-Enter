function comparemine() {
    ...
    // Contador para os checkboxes checados
    let checkedCount = 0;
...
function SetCarToCompare(ids_checkboxes) {
    ...
    function getCarDataById(id) {
        id = parseInt(id);
        return info_veiculos[id];
    }

    let veiculo1 = getCarDataById(parseInt(ids_checkboxes[0]) - 1);
    let veiculo2 = getCarDataById(parseInt(ids_checkboxes[1]) - 1);
